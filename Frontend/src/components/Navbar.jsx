...
export default function Navbar() {
    ...
    return (
        <>
            {/* <div className="fixed top-96 opacity-50 right-0 w-11/12 -z-10 translate-y-[-80%] dark:hidden">
                <img src="./assets/header-bg-color.png" alt="" className="w-full" />
            </div> */}

            <nav ref={navRef} className="w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 font-Outfit">

                <a href="#" className='flex'>
                   <h1 className='font-bold text-2xl tracking-wider'>Portfolio</h1>
                   <div className='w-2 h-2 rounded-full bg-gradient-to-r from-[#b820e6] to-[#da7d20]'></div>
                </a>

                <ul ref={navLinkRef} className="hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3 bg-white shadow-sm bg-opacity-50 font-Montserrat dark:border dark:border-white/30 dark:bg-transparent ">
                    ...
                    <li><a className='hover:text-gray-500 dark:hover:text-gray-300 transition' href="#experience">My Experience</a></li>
